        ...
        <div className="relative w-full">
            ...
            <div className="absolute inset-0 w-full flex flex-col items-center justify-center text-white text-center px-5">
                ...
                <div className="flex flex-col w-full space-y-4">
                    <p className="text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi quia maiores dicta harum, unde esse reiciendis quam. Dicta molestiae iste omnis ratione ipsa nam expedita odit. Neque reprehenderit illum dolore.</p>
