    ...
    return (
        <div className="grid h-screen place-content-center bg-white px-4 dark:bg-gray-900">
            <div className="text-center">
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">No hemos encontrado la categoria.</p>
                <Link
                    href="/products"
                    className="mt-6 inline-block rounded bg-primary px-5 py-3 text-sm font-medium text-white hover:bg-hardprimary focus:outline-none focus:ring"
                >
